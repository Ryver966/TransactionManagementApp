...
export const NotificationBanner: React.FC<IProps> = ({ message, onClose }) => {
  if (!message) return null;

  return (
    <div
      className={cx('absolute left-1/2 rounded transform -translate-x-1/2 w-full max-w-lg mx-10 p-8', {
